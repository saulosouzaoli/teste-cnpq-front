...
export class RegistroPontoService extends GenericService<RegistroPonto> {
  ...
  buscar(page: number, linesPerPage: number, orderBy: string, direction: string,idFuncionario:number): Observable<Page<RegistroPonto>> {
    ...
    if (direction)
      ...
      if (idFuncionario)
      params = params.set('funcionario', idFuncionario+"");
